[Diagnostics.CodeAnalysis.SuppressMessageAttribute('PSAvoidUsingPlainTextForPassword', '', Justification='Value will be stored unencrypted in .env, and used only for transient local development environments', Scope='Function')]
...
Add-HostsEntry "id.team451.localhost"
Add-HostsEntry "cm.team451.localhost"
